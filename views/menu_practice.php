...
// print "<br>trialId $target_icon_id<br>";
// print "<br>trialId $trial_id<br>";
?>
...
<div class="outer">
    <div class="middle">
        <div class="inner">
            ...
            <div align="center">
                ...
                <table style = "margin-top: 10px"; width="100%" height="100%" align="center" >
	...
	$index = $row['icon_id'];
                       ...
                       // if/else event here
                      //  print "<img onclick=\"show('$img')\" height=\"58\" width=\"60\" src=\"./images/$img\"><br>";
...
<script>
    ...
    function show(selectedIconId){
        ...
        if(targetIconId == selectedIconId){
           location.href = 'target_practice.php?status=true&trial_id='+trialId;
        }
        else{
            location.href = 'feedback_practice.php?status=false&trial_id='+trialId;
        }
